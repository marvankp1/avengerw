...
Asena.addCommand({pattern: 'info', fromMe: false, desc: 'Shows bot information and creator info'}, (async (message, match) => {
  ...
  r_text[0] = Config.LOGOSK;
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `` + Config.AVENGER + ` *BOT CREATED BY* ` + Config.MͥAͭRᷤVᷟAͤN +`
    
    ----- ` + Config.AVENGER + ` -----
    
╭─➤ 𝗜𝗡𝗙𝗢 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥 »
│❖ *ᴀᴜᴛʜᴏʀ* : ` + Config.AVENGER + `
│❖ *ᴋᴇʀɴᴇʟ* : ʟɪɴᴜx
